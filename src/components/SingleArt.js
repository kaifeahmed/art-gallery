...
<Row className='m-0 px-4 py-5 bg-theme' style={{ background: 'rgb(255 255 255 / 80%)', overflowX: 'auto' }}>
<Col xs= {6}>
    <h2 style={{fontWeight: '600'}}>About the work</h2>
...
<h3>Tunji Adeniyi-Jones</h3>
        ...
        <p><strong>2024:</strong> Connections: Wingate Studio at David Krut Projects, David Krut Projects</p>
        <p><strong>2021:</strong> Melodic Virtues, Morán Morán <br>
        </br>That Which Binds Us, White Cube</p> 
</Col>
</Row>
<Row  className='m-0 px-4 py-5 bg-theme' style={{ background: 'rgb(255 255 255 / 80%)', overflowX: 'auto' }}>
    <Col xs= {12}>

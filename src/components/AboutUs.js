...
const AboutUs = () => {
  return (
    <>
    <Row className='m-0 py-5 bg-theme align-items-center' style={{ backgroundImage: "linear-gradient(rgba(0,0,0,0.3), rgba(0,0,0,0.3)), url('https://picsum.photos/1920/1080?dark-art')", backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundAttachment: 'fixed', minHeight: '45vh'}}>
        <Col>
    ...
    <Row className='m-0 px-4 py-2 bg-theme' style={{ background: 'rgb(255 255 255 / 85%)'}}>
        <Col xs={6} style={{minHeight: '500px'}}>
            <div className="d-flex justify-content-end align-items-end" style={{ backgroundImage: "linear-gradient(rgba(0,0,0,0.3), rgba(0,0,0,0.3)), url('https://picsum.photos/1920/1080?creative-art')", height: '70vh', backgroundRepeat: 'no-repeat', backgroundSize: 'cover', borderRadius: '8px'}}>
        ...
        <Col xs={6} style={{minHeight: '500px'}}>
            <div className="d-flex justify-content-end align-items-end" style={{ backgroundImage: "linear-gradient(rgba(0,0,0,0.3), rgba(0,0,0,0.3)), url('https://picsum.photos/1920/1080?moderns-art')", height: '70vh', backgroundRepeat: 'no-repeat', backgroundSize: 'cover', borderRadius: '8px'}}>
                <p className='text-light mt-2 px-4 text-end' style={{fontSize: '16px', fontStyle: 'italic', fontWeight: '600'}}>Angela Heisch, Diving for Pearls, 2021</p>
            </div>
            <div className="d-flex justify-content-between align-items-center">
                <div>
        ...
        <Col xs={6} style={{minHeight: '500px'}}>
            <div className="d-flex justify-content-end align-items-end" style={{ backgroundImage: "linear-gradient(rgba(0,0,0,0.3), rgba(0,0,0,0.3)), url('https://picsum.photos/1920/1080?oil-art')", height: '70vh', backgroundRepeat: 'no-repeat', backgroundSize: 'cover', borderRadius: '8px'}}>
                <p className='text-light mt-2 px-4 text-end' style={{fontSize: '16px', fontStyle: 'italic', fontWeight: '600'}}>Angela Heisch, Diving for Pearls, 2021</p>
            </div>
            <div className="d-flex justify-content-between align-items-center">
                <div>
        ...
        <Col xs={6} style={{minHeight: '500px'}}>
            <div className="d-flex justify-content-end align-items-end" style={{ backgroundImage: "linear-gradient(rgba(0,0,0,0.3), rgba(0,0,0,0.3)), url('https://picsum.photos/1920/1080?street-art')", height: '70vh', backgroundRepeat: 'no-repeat', backgroundSize: 'cover', borderRadius: '8px'}}>
                <p className='text-light mt-2 px-4 text-end' style={{fontSize: '16px', fontStyle: 'italic', fontWeight: '600'}}>Angela Heisch, Diving for Pearls, 2021</p>
            </div>
            <div className="d-flex justify-content-between align-items-center">
                <div>
